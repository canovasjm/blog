...
Boot from the bootable USB stick you created above. To do so, press the "novo" button again and select "Boot Menu". 
...
**Before installing anything, try the "live" mode**: this way you can check at no cost if the distro you wish to install supports the hardware you have. You should see something like this (it's the first option):
