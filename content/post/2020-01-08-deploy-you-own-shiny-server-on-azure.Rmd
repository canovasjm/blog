...
`wget` is a free utility for download of files from the web and we use it download Shiny server from RStudio's website. It may or may not be installed with you CentOS version, but if it's missing you can install it by typing: `sudo yum install wget`  
